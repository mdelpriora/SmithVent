...
float readOxygenSensor() {//calculate and return concentration from oxygen sensor
  ...
  analogRead(O2_SENSOR);                                              //discard first reading
  double O2concentration = ((114.81)*(O2SensorReading)) + 11.805;     //equation found from testing, calculate concentration from voltage
  return O2concentration;               x                              //returns calculated O2 concetration value
}
